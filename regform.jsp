            ...
            <td>
                <table>
                    <form action="" method="post">
                        <tr><td>Name:</td><td><input name="name" value="<%=(request.getParameter("name")!=null)?request.getParameter("name"):""%>"/></td></tr>
                        ...
                        <tr><td>Comment:</td><td><textarea rows=6 cols=22 name="comment"/><%=(request.getParameter("comment")!=null)?request.getParameter("comment"):""%></textarea></td></tr>
