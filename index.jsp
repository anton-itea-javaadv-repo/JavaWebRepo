...
<%
    ...
    //Если хоть один параметр пришёл
    {
        if (login == null || login.isEmpty()) {
            ...
            isError = true;
            errorText += "<li>Login is invalid!</li>";
        }
        if (password == null || password.isEmpty()) {
            ...
            isError = true;
            errorText += "<li>Password repeat is empty!</li>";
        } else if (!password.equals(passwordRepeat)) {
            isError = true;
            errorText += "<li>Passwords entered does not match!</li>";
        } else {
            ...
            if (!(hasUpperCase && hasLowerCase && hasDigit) || password.length() < 8) {
                isError = true;
                errorText += "<li>Passwords should contain uppercase, lowercase letter and a digit<br/>and should contain 8 symbols or more!</li>";
            }
        }
        if (gender == null || gender.isEmpty()) {
            ...
            isError = true;
            errorText += "<li>Gender is invalid!</li>";
        }
        if (region == null || region.isEmpty()) {
            ...
            isError = true;
            errorText += "<li>Region is invalid!</li>";
        }
        ...
        if (!(browser == null || "on".equals(browser))) {
            isError = true;
            errorText += "<li>browser is invalid!</li>";
        }
        errorText += "</ul>";
        if (!isError) {
            showForm = false;
...
<%
        if (isError) {
            out.write("<td><font color=\"red\">" + errorText + "</td>");
        }
%>
        </tr>
    </table>
