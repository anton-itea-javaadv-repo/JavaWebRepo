...
import ua.itea.scratchesl10.dao.DbConnector;
import ua.itea.scratchesl10.dao.MySqlProductDao;
import ua.itea.scratchesl10.dao.ProductDao;
...
public class CartController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (changeId != null && !changeId.isEmpty()) {
            ...
            resp.getWriter().write("["+countProducts+", "+sumProductPrices+", "+removedProductFromCart+"]");
        } else {
