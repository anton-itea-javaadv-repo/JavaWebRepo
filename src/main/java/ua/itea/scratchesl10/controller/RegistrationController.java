package ua.itea.scratchesl10.controller;

import ua.itea.scratchesl10.dao.Dao;
...
import static ua.itea.scratchesl10.controller.LoginController.*;
import static ua.itea.scratchesl10.util.StaticUtils.*;
        ...
        //Если хоть один параметр пришёл
        {
            ...
            if (!isError) {
                ...
                if (user == null) {
                    ...
                    Optional<UserDto> userExistsOpn = dao.get(userReg.getLogin());
                    if (userExistsOpn.isPresent() && !Objects.equals(userReg.getLogin(), user.getLogin())) {
                        ...
                        Optional<UserDto> userOpn = dao.get(userReg.getLogin());
